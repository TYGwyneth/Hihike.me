...
function initialize() {
    ...
    //var url = "https://api.instagram.com/v1/tags/" + tag + "/media/recent?callback=?&amp;client_id=XXXce&count=33"
  ...
  function makeMarker(locations) {
    ...
    function search(tag) {
      console.log(tag);
      var url = "https://api.instagram.com/v1/tags/" + tag + "/media/recent?callback=?&amp;client_id=XXX&count=30";
      $.getJSON(url, addLocations);
    }

    /*function paginate() {
      var nextUrl = "https://api.instagram.com/v1/tags/" + tag + "/media/recent?callback=?&amp;client_id=XXX&max_id=" + maxID + "&count=33";
      var locations = new Array();
